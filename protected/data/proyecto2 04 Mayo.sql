...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-05-2014 a las 00:21:09
...
(4, 2, 'Definición, dominio y representación gráfica de una función.', 'Clase introductoria al concepto de función y el dominio. Representaciones gráficas de funciones en el plano cartesiano.');
...
(1, NULL, NULL, 1399237985, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, NULL, NULL, 1370560598, 'invitado', 'invitado', NULL, NULL, 1, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 1370904527, NULL, 1399076189, 'ricardo', 'ricardo@correo.com', 'ricardo', 'db06705fbe537cd1c6274546f6ede22d', 1, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 1372107077, NULL, 1399237147, 'profesor1', 'prof1@uc.edu.ve', 'profesor1', 'e4367f0196ac62802b73f45a7d0971c4', 1, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(2, 'Calculo I', 'Con este curso se pretende que el estudiante se familiarice con los conceptos propios del análisis matemático y este en capacidad de emplear las funciones para modelar fenómenos relacionados con su actividad profesional así como emplear la derivada para analizar crecimientos y decrecimientos, resolver problemas de optimización y de razón instantánea de cambio.', 'profesor2', 30);
...
(2, 2, 'Límite de funciones de variable real', 'Establecer el concepto de límite de una función y sus propiedades.');
...
ALTER TABLE `curso_estudiantes`
  ADD CONSTRAINT `curso_estudiantes_ibfk_1` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id_curso`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `curso_estudiantes_ibfk_2` FOREIGN KEY (`username_estudiante`) REFERENCES `cruge_user` (`username`) ON DELETE CASCADE ON UPDATE NO ACTION;
...
ALTER TABLE `evaluacion`
  ADD CONSTRAINT `evaluacion_fk` FOREIGN KEY (`id_tipo_evaluacion`) REFERENCES `tipo_evaluacion` (`id_tipo_evaluacion`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `respuesta_estudiante`
  ...
  ADD CONSTRAINT `respuesta_estudiante_fk1` FOREIGN KEY (`id_respuesta`) REFERENCES `respuesta` (`id_respuesta`) ON DELETE CASCADE ON UPDATE CASCADE;
