...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-02-2014 a las 23:14:02
...
INSERT INTO `clase` (`id_clase`, `id_tema`, `nombre_tema`, `descripcion_clase`) VALUES
...
(1, NULL, NULL, 1387226869, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, NULL, NULL, 1370560598, 'invitado', 'invitado', NULL, NULL, 1, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 1370904527, NULL, 1371151264, 'ricardo', 'ricardo@correo.com', 'ricardo', 'db06705fbe537cd1c6274546f6ede22d', 1, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 1372107077, NULL, 1388353935, 'profesor1', 'prof1@uc.edu.ve', 'profesor1', 'e4367f0196ac62802b73f45a7d0971c4', 1, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `evaluacion` (
  ...
  `username_estudiante` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `porcentaje` int(11) DEFAULT NULL,
  `numero_items` int(11) DEFAULT NULL,
  `duracion` int(11) DEFAULT NULL,
  `numero_max_tips` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_evaluacion`),
  UNIQUE KEY `id_tipo_evaluacion` (`id_tipo_evaluacion`),
...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  `texto_item` text COLLATE utf8_unicode_ci NOT NULL,
  `respuesta_item` text COLLATE utf8_unicode_ci NOT NULL,
  `tip_item` int(11) NOT NULL,
  PRIMARY KEY (`id_item`),
...
(1, 1, 'holamundo', 'C:\\xampp\\htdocs\\Tesis\\Recursos', NULL, 153);
...
ALTER TABLE `evaluacion`
  ADD CONSTRAINT `evaluacion_ibfk_1` FOREIGN KEY (`id_tipo_evaluacion`) REFERENCES `tipo_evaluacion` (`id_tipo_evaluacion`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `evaluacion_ibfk_2` FOREIGN KEY (`id_clase`) REFERENCES `clase` (`id_clase`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Filtros para la tabla `item`
--
ALTER TABLE `item`
  ADD CONSTRAINT `item_ibfk_1` FOREIGN KEY (`id_evaluacion`) REFERENCES `evaluacion` (`id_evaluacion`) ON DELETE CASCADE ON UPDATE NO ACTION;
